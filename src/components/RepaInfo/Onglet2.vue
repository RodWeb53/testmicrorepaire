  ...
  <div class="boite">
    <div>
      ...
      <div class="shadow pl-4 pt-2 pb-2 mt-2 mb-2 rounded contenu">
        <p><img src="./flecheblanc.png" alt="flèche blanche">Disque dur, port USB, mémoire</p>
      </div>
      <div class="shadow pl-4 pt-2 pb-2 mt-2 mb-2 rounded contenu">
        <p><img src="./flecheblanc.png" alt="flèche blanche">Carte mère, carte Wifi, carte bluetooth</p>
      </div>
      <div class="shadow pl-4 pt-2 pb-2 mt-2 mb-4 rounded contenu">
        <p><img src="./flecheblanc.png" alt="flèche blanche">Clavier, écran</p>
      </div>
    </div>
  </div>
